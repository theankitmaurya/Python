...
"""
The "requirements.txt" file -> In addition to creating and activating a virtual environment, it can be useful to create a requirements.txt file that lists the packages and their versions that your project depends on. This file can be used to easily install all the required packages in a new environment.

To crate a requirements.txt file, we can use the pip freeze command, which outputs a list of installed packages and their versions.

# Output the list of installed packages and their versions to a file:
pip freeze > requirements.txt

To install the packages listed in the requirements.txt file, we can use the pip install command with -r flag:
