# What is Python ??
# (1) Python is a dynamically typed, general purpose language that supports an object-oriented programming approach as well as a functional programming approach.
...
# (6) It is used in business and accounting to perform complex mathematical operations with quantitative and qualitative analysis.
